...
import com.mikufan.meks.flight.impl.event.RollGroupImpl;
 ...
 * <pre>{@code
 * class ModClass {
 *     public static final RollGroup ROLL_GROUP = RollGroup.of(new ResourceLocation("my_mod", "my_roll_group"));
 *
